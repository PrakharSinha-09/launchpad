      ...
      <div className="flex justify-center flex-col md:w-2/3">
        ...
        >
          ...
          <div className="flex-1 sm:py-0 py-4">
            ...
            <div>
              <p className="text-sm font-light mt-2 text-white">{project?.description}</p>
              <div className="w-full overflow-hidden bg-white mt-4">
                <div
              ...
              <div className="flex justify-between items-center font-bold mt-2">
                <small className='text-white'>{project?.raised} ETH Raised</small>
                <small className="flex justify-start items-center">
                  <FaEthereum />
                  <span className='text-white'>{project?.cost} ETH</span>
                </small>
              </div>
